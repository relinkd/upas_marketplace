...
```
dfx canister call indexer verifyIssuer "(principal \"by6od-j4aaa-aaaaa-qaadq-cai\", \"icrc-7\", record {\"by6od-j4aaa-aaaaa-qaadq-cai\"; \"Relinkd Issuer\"; \"Test relinkd-issuer for example\"})"
```